          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="animate-fade-in-up delay-300">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4 rounded-xl p-4 -m-4 hover:bg-gray-800/30 transition-colors duration-200">
                  <a href="mailto:sakshamxdevs@gmail.com" className="flex items-center space-x-4 w-full">
                    <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span className="text-gray-400 hover:text-gray-300 transition-colors duration-200">sakshamxdevs@gmail.com</span>
                  </a>
                </div>
                <div className="flex items-center space-x-4 rounded-xl p-4 -m-4 hover:bg-gray-800/30 transition-colors duration-200">
                  <a href="tel:+910000000000" className="flex items-center space-x-4 w-full">
                    <svg className="w-6 h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <span className="text-gray-400 hover:text-gray-300 transition-colors duration-200">+91 0000000000</span>
                  </a>
                </div>
                <div className="flex items-start space-x-4 rounded-xl p-4 -m-4 hover:bg-gray-800/30 transition-colors duration-200">
                  ...
                  <span className="text-gray-400 hover:text-gray-300 transition-colors duration-200 leading-relaxed">SRMIST, C Block, 1, Jawaharlal Nehru Salai, Vadapalani, Chennai, Tamil Nadu 600026</span>
                </div>
              </div>
            </div>
          </div>
